...
public class DeathPanel : MonoBehaviour
{
    ...
    private IEnumerator Step2_FinalStep()
    {
        ...
        // คืนค่าเวลาให้เกมกลับมาเดินตามปกติทันทีที่เริ่ม Fade ออก
        Time.timeScale = 1f;
    ...
    private void ResetPanelUI()
    {
        ...
        {
            agentCodeText.text = "";
            agentCodeText.gameObject.SetActive(false);
            Color c = agentCodeText.color;
            c.a = 1f;
            agentCodeText.color = c;
            agentCodeTextRect.anchoredPosition = welcomeTextOriginalPos + agentCodeOffsetRight;
        }
    }
}